---
title: "Machine à Empêcher de Vivre, Machine à Rendre Capable de Vivre"
...
canonical_url: https://github.com/JeanHuguesRobert/barons-Mariani/blob/main/projects/suicide-corse/manuscript/05-machine-a-rendre-capable-de-vivre.md
...
# Machine à Empêcher de Vivre, Machine à Rendre Capable de Vivre
...
## La chaîne à niveau de preuve variable
...
L'architecture d'enquête distingue déjà trois espaces (`A_eff`, `A_perçu`, `A_désirable`, voir [`architecture.md`](../architecture.md)). La chaîne ci-dessus traverse les trois :
...
## Le symétrique constructif : rendre capable de vivre
...
## Une charge documentée n'est pas une fermeture
...
## Ce que ce chapitre n'affirme pas
