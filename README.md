...
Ce dépôt est la préfiguration du **Fonds de dotation Barons Mariani** — institution
en cours de constitution dont la mission est de conserver le domaine de
Minesteggio (Corte, Haute-Corse), de faire vivre la mémoire de la famille
Mariani, et d'en assurer la transmission patrimoniale hors du marché, par
affectation perpétuelle à une fin d'intérêt général.

Il rassemble en parallèle les travaux de recherche en sciences humaines, droit,
politique et technologies de Jean Hugues Noël Robert, baron Mariani — pendant
du projet [MareNostrum](https://github.com/JeanHuguesRobert/marenostrum) sur le
versant diagnostic : comprendre pourquoi les institutions centralisées échouent
...
Principale propriété corse de la famille, domaine agricole situé à Corte
(Haute-Corse). Le site est stratifié en trois niveaux territoriaux : le
Castelare romain potentiel sur la hauteur, le système hydraulique de la rivière Orta, et le
domaine agricole proprement dit.

Une maison remarquable, villa florentine du début du XIXièle siècle, baptisée localement Château Mariani, et les jardins autour sont en cours
d'inscription aux Monuments Historiques (DRAC Corse).

Le **Fonds de dotation Barons Mariani** a vocation à devenir propriétaire de
Minesteggio, en assurant sa conservation et son ouverture au public. Lucas
Robert et Marie-Louise Robert, enfants du baron Mariani, en sont les acteurs
familiaux ; la transmission juridique s'opère vers le fonds, non vers des
héritiers en titre, afin de soustraire le domaine définitivement aux aléas
successoraux.
...
Le Musée Mariani est le projet économique de Minesteggio — son moteur de
revenus et sa raison d'être publique. Il se construit selon une logique
possibiliste : partir de la fin, progressivement.

La première étape en cours est la **boutique du musée**, dans une version
minimale et mobile, destinée à générer les premières entrées d'argent avant
même qu'un espace muséal physique soit ouvert. L'horizon est un musée uchronique
...
Ses axes principaux : souveraineté énergétique des communes de montagne
(agrivoltaïque, micro-STEP, datacenters souverains containerisés), revenu
...
### 🚀 FractaVolta — Startup à impact

*Actif — en développement.*

FractaVolta explore le passage d'une architecture de distribution d'énergie
à base de **circuits** vers une architecture à base de **paquets** — le même
saut conceptuel qu'Internet a opéré pour les données, appliqué à l'énergie
électrique. Une architecture en paquets permet de router l'énergie vers les
usages où son *exergie* — sa capacité à produire un travail utile en contexte —
est maximale, plutôt que de la distribuer indistinctement.
...
Formalise un mécanisme structurel rendant compte du paradoxe selon lequel les
progrès objectifs s'accompagnent d'une intensification de la perception d'échec.
Contribution centrale : un **indice de sévérité perçue** S(t) = Δ(t)/(1 − Q(t)),
dont la croissance est démontée monotone même lorsque le déficit absolu se
...
Propose le **cycle DRSJ** — modèle articulant quatre cadres analytiques
(Klein/Schoeck, Girard, Dunning, Fehr) pour rendre compte de la transformation
récurrente d'une réussite observée en problème moral légitimant une sanction
...
Propose la reconnaissance d'un **principe de continuité de protection** pour
les personnes traversant plusieurs régimes de vulnérabilité sans qu'aucune
instance n'en assure la cohérence. S'appuie sur le cas de Marie-Louise Robert
...
### 🇬🇧 *Literary Works as Navigable Spaces of Counterfactual Semantics*

*Note de digital humanities.*

Cadre en trois couches (corpus immuable → extraction structurelle → médiation
...
Architecture en cinq couches pour la gouvernance démocratique de l'IA, avec
...
### 🇫🇷 VIGILIA — Détection distribuée animaux/véhicules

*Concept note — statut : prototype papier.*

Architecture de capteurs distribués (balises LoRaWAN, RSSI, GPS) pour la
...
Fondée à Corte en **1995** — antérieure au terme même d'*open source* (apparu
en février 1998) — l'association *Corse Organisant la Réunion Sur Internet de
Compétences Autonomes* a pour objet la promotion de la démocratie directe
numérique et la défense des biens communs.

Réalisations notables : premier annuaire des sites internet corses, logiciel de
vote Kudocracy (présenté à Bruxelles), démocratie liquide, jardins partagés de
Corte, universités de la transition corse, sentier botanique de l'Orta, et
depuis 2018, l'Institut Mariani.

---

## Institut Mariani

Émanation de C.O.R.S.I.C.A., l'Institut conduit des travaux expérimentaux sur
les pratiques démocratiques, les biens communs, et la gouvernance de
l'intelligence artificielle. Adresse : 1 cours Paoli, F-20250 Corte.

Travaux en cours : dossier Minesteggio (DRAC Corse), cadre MareNostrum
(CC BY-SA 4.0), FractaVolta, Musée Mariani.

---

## Licence

L'ensemble des contenus de ce dépôt est publié sous licence
**Creative Commons CC BY-SA 4.0**, à l'exception des éléments héraldiques
issus de Wikimedia Commons (licence propre). Le blason est issu de l'
[Armorial des familles de Corse](https://fr.m.wikipedia.org/wiki/Armorial_des_familles_de_Corse).
