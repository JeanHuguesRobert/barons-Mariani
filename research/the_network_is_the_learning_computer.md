...
# Appendix J — v0.8 JHN Architecture Rationale and Lineage Migration

This appendix integrates the explanatory rationale, conceptual comparisons and implementation lineage migrated from `research/jhn_architecture.md` when that document was retracted into a short normative conformance specification (v0.3).
