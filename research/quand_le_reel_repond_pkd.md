---
title: "Quand le Réel répond"
subtitle: "Philip K. Dick, l’intelligence artificielle et l’épreuve des conséquences"
description: "French sovereign source essay using Philip K. Dick as a diagnostic instrument for reality, possibility, personhood, power, and consequence in the age of AI."
...
related_documents:
  ...
  - "https://github.com/JeanHuguesRobert/Inox/blob/master/research/inox-since-2021-orientation-note.md"
...
provenance:
  ...
  origin_ref: "https://github.com/JeanHuguesRobert/barons-Mariani/issues/54"
...
## Philip K. Dick, l’intelligence artificielle et l’épreuve des conséquences

### Control / corpus orientation
...
## Ouverture — Le thermomètre a-t-il une voix ?

Dix intelligences artificielles examinent une pièce. Elles disposent de bibliothèques immenses, de modèles sophistiqués et de bonnes raisons de se faire confiance. Elles délibèrent. Elles se corrigent. Elles confrontent leurs chaînes de raisonnement. Après quelques tours, elles convergent : il fait vingt-deux degrés.

Sur la table, un thermomètre indique dix-sept.

Combien de voix possède le thermomètre ?

Aucune, si l’on parle de démocratie. Mais ce n’est pas de démocratie qu’il s’agit.

Le thermomètre peut être faux. Il peut être mal étalonné, posé au mauvais endroit, cassé. Il n’est ni oracle ni juge. Pourtant il introduit dans la pièce quelque chose que les dix intelligences ne peuvent produire simplement en se consultant davantage : une chaîne causale qui ne dépend pas entièrement de leur conversation. Quelque chose venu d’ailleurs peut les obliger à reprendre leur modèle.

C’est une petite scène, presque enfantine. Philip K. Dick a passé sa vie à la rendre beaucoup plus inquiétante.

Dans ses romans, les thermomètres mentent parfois. Les murs parlent. Les objets vieillissent à rebours. Les souvenirs ont été fabriqués. Le journal du matin ne décrit pas nécessairement le monde dont vous vous souvenez la veille. Une machine destinée à assister devient un pouvoir qui décide. Un être fabriqué peut sembler plus délicat qu’un homme qui le traque. Une société entière peut vivre dans un décor politiquement entretenu. Et lorsque quelque chose enfin paraît venir corriger l’illusion, rien ne garantit que la correction ne provienne pas du même endroit que le mensonge.

On appelle souvent Dick un prophète de notre époque. La formule est flatteuse et, à mes yeux, assez pauvre. Il n’a pas prédit ChatGPT. Il n’a pas dessiné nos centres de données, nos modèles multimodaux ou nos robots. Ses machines ont vieilli comme toutes les machines imaginaires. Ce qui a moins vieilli, ce sont les situations où il place ses personnages : des situations dans lesquelles des choses que nous avions l’habitude de faire coïncider cessent soudain de coïncider.

L’apparence et la source. L’intelligence et la légitimité. La décision et celui qui en supporte les conséquences. La personne et l’image par laquelle elle nous apparaît. Le monde qui est là et celui qui aurait pu être.

Je voudrais prendre ces dissociations au sérieux, non comme les fragments d’une doctrine secrète de Philip K. Dick, mais comme autant de chambres d’expérience. La littérature ne prouvera rien. Elle fera mieux, si nous lui demandons correctement : elle fabriquera des situations dans lesquelles une question devient impossible à éviter.

La question centrale de cet essai est simple à formuler et plus difficile à tenir : **qu’est-ce qui revient vers celui qui pense, décide ou agit ?**
