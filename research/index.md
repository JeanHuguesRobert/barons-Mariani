---
title: Research Index — barons-Mariani
...
| Title | Location | Date |
|---|---|---|
| [AGENTS.md — Barons Mariani corpus mandate](../AGENTS.md) *(repository-local operational instructions for agents and assistants working inside this high-authority corpus repository)* | this repo | 2026-06-13 |
...
| [Amendement d’effectivité — version parlementaire candidate et note de justification](autonomia/amendement_effectivite_article_72-5.md) *(v0.4-rc4 — proposition publique, non documentée comme déposée ou adoptée ; mise en œuvre effective, évaluation périodique, Liberté-Égalité-Fraternité)* | source | 2026-09-26 |
