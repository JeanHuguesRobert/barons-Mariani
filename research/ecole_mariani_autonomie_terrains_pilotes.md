...
L’École Mariani de l’Autonomie ne doit pas rester une doctrine générale. Elle doit s’ancrer dans des terrains pilotes suffisamment différents pour faire apparaître les invariants de la méthode et les adaptations nécessaires selon les situations réelles.

Quatre terrains pilotes sont identifiés à ce stade :

1. un cas domestique ordinaire : remplacer ou compléter un cumulus électrique dépendant d’EDF par une solution d’eau chaude plus sobre, hybridable et documentée ;
2. Minesteggio : résidence d’été patrimoniale, non habitée en hiver, disposant de soleil et d’une ressource hydraulique potentielle liée à l’Orta ;
3. La Maison Blanche à La Gaude : maison d’expérimentation pour des solutions d’autonomie plus reproductibles en habitat individuel ;
4. une maison individuelle urbaine à Corte, cas pilote anonymisé tant que la personne concernée ne s’est pas engagée publiquement.

Ces terrains couvrent quatre situations pédagogiques :

- l’autonomie de la personne et du foyer ordinaire ;
- l’autonomie d’un lieu patrimonial saisonnier ;
- l’autonomie expérimentale d’une maison individuelle reproductible ;
- l’autonomie urbaine en maison de ville, avec contraintes de toiture, voisinage, usages familiaux et arbitrage entre confort, sobriété et coupure éventuelle d’EDF.
...
L’autonomie ne peut pas être enseignée uniquement par des principes abstraits.

Elle doit être apprise sur des cas situés.

Chaque terrain pilote doit donc fonctionner comme :

- un révélateur des dépendances ;
- un support pédagogique ;
- un banc de mesure ;
- une base documentaire ;
- un laboratoire de sobriété ;
- un lieu de transmission ;
- une preuve que l’IA peut augmenter la capacité des personnes lorsqu’elle est utilisée avec méthode.

Le coach d’autonomie n’applique pas une solution standard. Il accompagne une personne ou un collectif dans la reprise de compréhension de son propre milieu.
...
Le problème paraît trivial : produire de l’eau chaude.

Il révèle pourtant plusieurs dépendances :

- dépendance à l’électricité réseau ;
- puissance appelée par le cumulus ;
- pertes permanentes du stockage ;
- méconnaissance du besoin réel d’eau chaude ;
- incapacité fréquente à comparer les alternatives ;
...
Cette caractéristique change fortement le problème énergétique.

Il ne s’agit pas nécessairement de couvrir des besoins continus de chauffage hivernal. Il s’agit plutôt de rendre un lieu patrimonial plus autonome pour :

- l’occupation estivale ;
...
1. le soleil ;
2. l’eau de l’Orta, avec un dénivelé disponible d’environ 20 mètres, un tuyau agricole d’environ 60 mm, et un débit modeste restant à mesurer.

Le soleil est cohérent avec une résidence d’été : les besoins principaux apparaissent lorsque la ressource solaire est forte.
...
- ρ : masse volumique de l’eau, environ 1000 kg/m³ ;
- g : gravité, environ 9,81 m/s² ;
- Q : débit en m³/s ;
- H : hauteur de chute, ici environ 20 m ;
- η : rendement global turbine + générateur + pertes, à mesurer ou estimer.

Avec 20 m de dénivelé, les ordres de grandeur sont :

| Débit mesuré | Puissance hydraulique brute | Puissance utile plausible |
|---:|---:|---:|
| 0,5 L/s | environ 100 W | 40 à 60 W |
| 1 L/s | environ 200 W | 80 à 120 W |
| 2 L/s | environ 400 W | 160 à 240 W |
| 5 L/s | environ 1 kW | 400 à 600 W |
...
> L’autonomie d’un lieu commence par la compréhension de son rythme d’usage.
...
Elle doit être pensée comme un cas de maison individuelle plus classique que Minesteggio, mais suffisamment disponible pour tester des solutions d’autonomie reproductibles.

Elle peut servir de banc d’essai pour :

- mesure des consommations ;
- réduction de la dépendance EDF ;
- solaire ;
- stockage ;
- courant continu ;
- eau chaude hybride ;
- gestion des charges ;
- petits systèmes de supervision ;
...
> La Maison Blanche peut servir de banc d’essai résidentiel pour transformer l’autonomie technique en pédagogie reproductible.
...
L’identité de cette personne doit rester masquée tant qu’elle ne s’est pas engagée publiquement.

Dans le corpus public, ce cas doit donc être désigné comme :
...
- maison individuelle urbaine à Corte ;
- surface habitable d’environ 100 m² ;
- foyer de quatre personnes ;
- toiture à deux pentes, d’environ 100 m² au total, dont environ la moitié bien orientée au sud ;
- garage ;
- chauffe-eau thermodynamique d’environ dix ans ;
- climatisation ;
- chauffage principalement au bois ;
- voiture thermique ancienne, de type Peugeot 206, avec hypothèse de remplacement par un véhicule électrique ;
- objectif possible : aller vers une autonomie très forte, voire une coupure EDF si les conditions techniques, économiques, familiales et réglementaires le permettent.
...
C’est une maison familiale urbaine réelle, avec des usages ordinaires et des contraintes concrètes.

Il permet de tester :

- l’autonomie en ville ;
- les arbitrages familiaux ;
- la combinaison toiture solaire / eau chaude thermodynamique / bois / climatisation / batterie ;
- la question du véhicule électrique ;
...
- produire les listes de mesures ;
- formuler les questions aux professionnels ;
...
> IA = suggestion, éclairage, simulation, documentation. Décision = personne informée, accompagnée, responsable.
...
La doctrine générale devient opératoire lorsqu’elle se confronte à :

- un cumulus ;
- une résidence d’été ;
- une maison expérimentale ;
- une maison familiale urbaine ;
- un foyer réel ;
- une toiture réelle ;
- un débit réel ;
- une facture réelle ;
...
> Les terrains pilotes ne servent pas à démontrer que l’autonomie est facile. Ils servent à apprendre comment elle devient possible.
