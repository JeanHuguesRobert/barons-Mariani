---
title: "Kudocracy"
subtitle: "Recommandation civique traçable, votations et démocratie liquide assistée par agents"
description: "Working paper sur Kudocracy comme couche de recommandation civique traçable pour des votations, complémentaire de la démocratie liquide et adjacente aux mandataires représentatifs."
...
**Abstract —** Liquid democracy is usually framed as a hybrid between direct and representative democracy, allowing citizens either to vote directly or to delegate their voting power to proxies. Kudocracy proposes a complementary model focused on *votations* rather than elections: citizens vote on proposals, as in referendum-style direct democracy, while still allowing representative mandates to exist in adjacent institutional layers. Instead of primarily transferring voting power, citizens may subscribe to traceable recommendations issued by human, collective, or artificial agents. These recommendations may be followed, ignored, overridden, or revoked, while preserving individual agency and public auditability. A personal AI agent may act as a civic guardian, helping each citizen compare recommendations, detect inconsistencies, preserve value alignment, and protect long-term interests. Kudocracy is therefore not merely an online voting mechanism, but a model of agent-assisted civic orientation, positioned between liquid democracy, deliberative systems, recommender architectures, and democratic AI governance.

---

## Mots-clés

Kudocracy ; démocratie liquide ; votations ; démocratie directe ; recommandations civiques ; agents IA ; agent personnel ; mandataires ; traçabilité ; auditabilité ; révocabilité ; autonomie de capacité ; Inseme ; Cogentia ; souveraineté citoyenne.
...
> **Kudocracy est une couche de recommandation civique traçable pour des votations sur propositions, complémentaire de la démocratie liquide et adjacente aux systèmes de mandataires, sans se confondre avec l’élection représentative.**
...
> **Avant de déléguer son vote, ou au lieu de le déléguer, le citoyen peut s’abonner à des recommandations civiques traçables.**

Ces recommandations peuvent être produites par des agents humains, collectifs ou artificiels. Elles peuvent être suivies, ignorées, contredites, comparées, révoquées ou transformées en délégation explicite.

Le cœur du modèle n’est donc pas l’élection. Le cœur du modèle est la **votation sur proposition**, assistée par des agents de recommandation.
...
> Les mandataires ne doivent pas absorber toute la capacité démocratique. Une société démocratique doit aussi pouvoir décider directement sur des propositions, avec des outils de recommandation, de traçabilité et de révocation adaptés à la complexité contemporaine.
...
Ce qu’elle ajoute est une couche de capacité civique : pouvoir se prononcer sur des propositions avec l’aide d’agents recommandateurs audités et révocables.
...
Une **proposition** est un objet soumis à discussion, recommandation, amendement ou vote.
...
- accompagnée de recommandations traçables ;
- réversible selon des conditions prévues.

## 3.3. Agent recommandateur

Un **agent recommandateur** est une source identifiable de recommandations civiques.
...
Son rôle n’est pas nécessairement de voter à la place du citoyen. Son rôle premier est de formuler une recommandation explicite, motivée, traçable et contestable.

## 3.4. Abonnement civique

Un **abonnement civique** est le lien volontaire par lequel un citoyen choisit de recevoir les recommandations d’un agent.
...
## 3.5. Recommandation civique

Une **recommandation civique** est un avis structuré portant sur une proposition.
...
Kudocracy privilégie la recommandation comme couche première. La délégation reste possible, mais elle doit être explicite, traçable, bornée et révocable.
...
# 4. De la démocratie liquide à la recommandation liquide
...
Kudocracy propose de placer la recommandation avant la délégation.

Cela produit plusieurs niveaux d’engagement :

| Niveau | Formule | Effet |
|---|---|---|
| Consultation | “Je lis cette recommandation.” | Information |
| Abonnement | “Je reçois les recommandations de cet agent.” | Orientation régulière |
| Suivi ponctuel | “Je suis cette recommandation pour cette proposition.” | Décision assistée |
| Suivi thématique | “Je suis cet agent sur ce domaine.” | Confiance spécialisée |
| Suivi conditionnel | “Je suis sauf alerte de mon agent personnel.” | Automatisation contrôlée |
| Délégation | “Je transfère temporairement mon vote.” | Décision par autrui |
| Reprise | “Je reprends directement la main.” | Réversibilité |

La recommandation liquide permet donc de bénéficier de la compétence d’autrui sans abandonner immédiatement son pouvoir de décision.

Elle correspond mieux à la réalité ordinaire du jugement humain : nous décidons rarement seuls, mais nous devons pouvoir savoir qui nous influence, pourquoi, avec quelles raisons, et avec quelle possibilité de correction.
...
2. Des agents recommandateurs produisent des recommandations.
3. Les citoyens s’abonnent à certains agents.
4. Les recommandations sont reçues, comparées, expliquées.
5. Chaque citoyen vote, s’abstient, suit, contredit ou délègue.
6. Les décisions et recommandations pertinentes sont tracées selon des règles publiques.
7. Les abonnements et délégations restent révocables.
8. L’historique produit une mémoire civique auditable.
...
Un citoyen ordinaire doit conserver une sphère de protection. Un agent recommandateur influent, un mandataire, un collectif militant, une IA publique ou une institution doivent accepter un niveau supérieur d’auditabilité.
...
- résumer les enjeux ;
- comparer plusieurs recommandations ;
...
- proposer une position motivée ;
- alerter contre un suivi automatique dangereux ;
- conserver une mémoire civique personnelle ;
- produire une explication compréhensible du vote recommandé.
...
- explicable dans ses recommandations ;
- corrigeable ;
- exportable ;
...
> **L’agent IA personnel ne vote pas à la place du citoyen ; il protège la capacité du citoyen à ne pas voter contre lui-même sans s’en rendre compte.**
...
Mais lorsqu’un agent produit une recommandation destinée à orienter une décision commune, cette recommandation relève d’un espace public ou semi-public. Elle doit pouvoir être auditée.
...
> **Plus un acteur prétend influencer la décision commune, plus ses recommandations doivent être explicites, traçables et vérifiables.**
...
- un agent IA personnel pour comparer les recommandations ;
...
> Sur cette proposition, dans ce contexte, je suis cette recommandation, pour telle raison, dans telle limite, et je conserve mon droit de reprise.
...
Un mandataire peut publier ses recommandations, ses votes, ses raisons, ses incertitudes et ses conflits d’intérêts. Il devient alors non seulement représentant, mais agent recommandateur responsable.

Dans cette perspective, Kudocracy ne remplace pas la représentation. Elle la désenclave.

Elle donne au corps politique les moyens de décider directement lorsque c’est pertinent, de contrôler les mandataires lorsque c’est nécessaire, et de bénéficier de recommandations traçables lorsque la complexité l’exige.

---

# 10. Différence avec les plateformes de recommandation commerciales

Kudocracy ne doit pas être confondue avec les systèmes de recommandation utilisés par les plateformes numériques.

Les plateformes commerciales recommandent souvent des contenus selon des objectifs implicites : engagement, rétention, publicité, temps d’écran, viralité, polarisation rentable.
...
Kudocracy inverse cette logique.

La recommandation civique doit être :
...
- paramétrable ;
- révocable ;
- orientée vers la capacité de décision du citoyen, non vers sa captation attentionnelle.
...
- capacité de recevoir des recommandations ;
- capacité de comparer les recommandations ;
- capacité de décider ;
...
À ce stade, l’enjeu prioritaire est de formaliser correctement le modèle : distinguer votation et élection, recommandation et délégation, agent recommandateur et mandataire, assistance IA personnelle et manipulation algorithmique.
...
Kudocracy propose donc une unité plus faible et plus inspectable : la recommandation.

Elle ne supprime pas la délégation. Elle la place après la recommandation, comme une option forte, explicite et révocable.
...
> **Kudocracy augmente la capacité démocratique lorsque des citoyens votent sur des propositions en s’appuyant sur des recommandations civiques traçables, produites par des agents humains ou artificiels auxquels ils s’abonnent librement, sans abandonner leur capacité de décision finale.**
...
| Une recommandation traçable peut augmenter la capacité de décision | Hypothèse principale |
...
### K2 — Recommandation avant délégation

**Claim.** La recommandation civique est une unité démocratique plus faible, plus réversible et plus auditable que la délégation du vote.

**Test.** Comparer, sur un cas simple, les effets d’un abonnement à recommandations et ceux d’une délégation automatique.

**Condition de révision.** Si les citoyens suivent mécaniquement les recommandations sans contrôle ni compréhension, la différence pratique entre recommandation et délégation devient insuffisante.
...
**Test.** Définir des seuils : citoyen ordinaire, agent recommandateur, agent influent, mandataire, institution, plateforme.
...
**Réponse.** Non. Le vote en ligne n’est qu’un canal. Kudocracy porte sur la structure de l’influence civique : propositions, recommandations, abonnements, agents, traçabilité, révocabilité, agent personnel.

Le cœur n’est pas le clic de vote. Le cœur est la chaîne de recommandation auditable qui précède la décision.
...
Le système doit cependant intégrer des garde-fous : pluralité des recommandations, alertes de concentration, justification obligatoire, comparaison contradictoire, révocation simple.
...
La condition de légitimité est l’alignement institutionnel : qui contrôle l’agent, qui le paramètre, qui audite ses recommandations, qui peut le remplacer ?
...
Kudocracy doit éviter d’ajouter une complexité illisible. Elle doit au contraire rendre la complexité navigable : propositions claires, recommandations lisibles, agent personnel, comparaisons simples, droit de reprise.

## Objection 7 — “La recommandation n’empêche pas la manipulation.”
...
La recommandation, l’abonnement, la délégation conditionnelle et l’agent personnel servent précisément à réduire la charge cognitive sans supprimer le droit de reprise.
...
1. Les citoyens ne distinguent plus recommandation et délégation.
2. Quelques agents captent l’essentiel de l’influence.
3. Les recommandations deviennent opaques ou non justifiées.
4. L’agent IA personnel est contrôlé par la plateforme plutôt que par le citoyen.
5. La traçabilité se transforme en surveillance sociale des citoyens ordinaires.
6. Les mandataires ne peuvent plus agir efficacement.
7. Les votations deviennent trop nombreuses et produisent fatigue ou abstention massive.
8. Les propositions sont mal formulées, ambiguës ou manipulatoires.
9. Le système favorise les acteurs déjà puissants.
10. Les données civiques deviennent captives d’un fournisseur non auditable.
...
## 17.2. Justification des recommandations

Un agent recommandateur doit fournir une justification minimale.

Une recommandation sans justification est un signal faible. Une recommandation avec justification devient un objet discutable.
...
Le système doit rendre visibles les recommandations divergentes.

Une démocratie de recommandation ne doit pas produire une monoculture d’influence.

## 17.5. Auditabilité des agents influents

Les agents recommandateurs qui acquièrent une influence significative doivent être plus fortement auditables.

L’audit doit porter sur leurs recommandations publiques, leurs sources, leurs conflits d’intérêts et leur historique, non sur leur vie privée sans lien avec leur rôle civique.

## 17.6. Contrôle citoyen de l’agent personnel

L’agent IA personnel doit pouvoir être corrigé, remplacé, exporté ou désactivé.

Il doit expliquer ses recommandations et signaler ses incertitudes.
...
## H1 — Recommandation traçable

Une recommandation civique traçable augmente la qualité perçue du vote par rapport à une recommandation opaque.
...
La comparaison de plusieurs agents recommandateurs réduit la dépendance à une source unique d’influence.
...
Les mandataires restent nécessaires, mais leur légitimité augmente lorsque leurs actes sont contrôlables par des votations et recommandations publiques.
...
- plusieurs agents recommandateurs ;
- des abonnements volontaires ;
- des recommandations justifiées ;
- la possibilité de suivre ou non une recommandation ;
- une révocation simple ;
- une trace exploitable ;
- une première assistance par agent IA personnel ;
- une distinction nette entre votation, recommandation, délégation et mandat.
...
C’est une architecture de votations assistées par recommandations civiques traçables.

Elle ne supprime pas les mandataires. Elle les situe dans un espace démocratique plus large, où les citoyens peuvent aussi décider directement sur des propositions, recevoir des recommandations, comparer des agents, suivre ou contredire, déléguer explicitement et reprendre la main.

Son originalité tient à quatre déplacements :

1. du vote pour des personnes vers la votation sur propositions ;
2. de la délégation du pouvoir vers la recommandation préalable ;
3. de l’influence opaque vers la recommandation traçable ;
4. de l’IA de plateforme vers l’agent IA personnel du citoyen.

La démocratie liquide a montré qu’il était possible de fluidifier la représentation. Kudocracy propose de fluidifier d’abord l’orientation civique.

Elle ne remplace pas le citoyen par un agent.

Elle donne au citoyen les agents nécessaires pour ne pas être remplacé par le système.
...
- version : `0.1`
- statut : working paper initial
- langue : français, abstract en anglais
- thèse : Kudocracy est une couche de recommandation civique traçable pour des votations sur propositions, complémentaire de la démocratie liquide et adjacente aux mandataires.
...
3. Distinguer explicitement :
   ...
   - agent personnel ;
   - agent recommandateur.
4. Appliquer la seconde méthode par :
   - thèse testée ;
   - statut épistémique ;
   - claims vérifiables ;
   - objections ;
...
- statut d’un agent recommandateur ;
...
> **Kudocracy ne remplace pas le citoyen par un agent. Elle donne au citoyen les agents nécessaires pour ne pas être remplacé par le système.**
...
5. renforcer les objections avant de renforcer la thèse ;
6. produire une version `v0.2` avec changelog explicite ;
7. maintenir le document compatible avec la seconde méthode.
